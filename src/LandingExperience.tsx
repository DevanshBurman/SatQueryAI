...
export default function LandingExperience({enter}:{enter:()=>void}){
  ...
  return <main className="sq-site" ref={root}>
    ...
    <section className="sq-hero" aria-labelledby="sq-title">
      ...
      <div className="sq-date-inset"><div><div className="sq-date-image sq-date-before"/><span>Ask naturally<small>One image or a pair</small></span></div><div><div className="sq-date-image"/><span>Inspect evidence<small>Source-linked answers</small></span></div></div>
